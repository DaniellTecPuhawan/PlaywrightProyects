...
(async () => {
  try {
    ...
    // Abre el script en los diferentes navegadores en modo headless (sin interfaz visible)
    ...
    await chromePage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 60000 });
    await firefoxPage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 60000 });
    await edgePage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 15000 });

    await chromePage.screenshot({ path: 'chrome1.png' });
    await firefoxPage.screenshot({ path: 'firefox1.png' });
    await edgePage.screenshot({ path: 'edge1.png' });
    ...
    await chromePage.screenshot({ path: 'chrome2.png' });
    await firefoxPage.screenshot({ path: 'firefox2.png' });
    await edgePage.screenshot({ path: 'edge2.png' });

    await chromePage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 60000 });
    await firefoxPage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 60000 });
    await edgePage.waitForSelector('.col-xs-5 > .nav__right > .nav__links > .nav__button-user > .c-button--session', { timeout: 15000 });

    await chromePage.screenshot({ path: 'chrome3.png' });
    await firefoxPage.screenshot({ path: 'firefox3.png' });
    await edgePage.screenshot({ path: 'edge3.png' });
    ...
    await chromePage.waitForSelector('#gigya-login-form .gigya-input-text', { timeout: 60000 });
    await firefoxPage.waitForSelector('#gigya-login-form .gigya-input-text', { timeout: 60000 });
    await edgePage.waitForSelector('#gigya-login-form .gigya-input-text', { timeout: 15000 });
